...
//               const uniqueStudentGroups = new Set(data.map(item => item.student_group));
//               console.log(uniqueStudentGroups)
              ...
              {isOpen[groupName] && (
                <div className="card-body p-2">
                  <table className="table table-bordered table-hover table-sm table-striped">
                    ...
                    <tbody>
                      {facultyData[groupName]?.map((faculty, index) => (
                        <tr key={index}>
                          <td>{faculty.name}</td>
                          <td>{faculty.lr1}</td>
                          <td>{faculty.lr2}</td>
                          <td>{faculty.lr3}</td>
                          <td>{faculty.lr4}</td>
                          <td>{faculty.final_grade}</td>
                          <td>{faculty.completion_date}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
